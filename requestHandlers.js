...
var home = require(__dirname + "/handlers/home.js");
var markets = require(__dirname + "/handlers/markets.js");
...
function setHandlers(app) {
    ...
    app.get("/markets/:marketName", markets.marketNotFound);
//    app.get("/markets/:marketName/:vendorName", markets.vendor);
